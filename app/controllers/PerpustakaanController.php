...
class PerpustakaanController extends Controller
{
  ...
  public function detailbuku($id)
  {
    $this->view('perpustakaan/buku', [
      ...
      'ulasan'  => $this->model('UlasanBukuModel')->getByBookID($id) // Mengubah menjadi UlasanBukuModel
    ]);
  }
  ...
  {
    if ($this->model('UlasanBukuModel')->create([ // Mengubah menjadi UlasanBukuModel
      'UserID'      => $_POST['UserID'],
      'BukuID'      => $_POST['BukuID'],
      'Ulasan'      => $_POST['Ulasan'],
      'Rating'      => $_POST['Rating'],
