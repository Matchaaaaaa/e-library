...
<head>
    ...
    <title>E-Library | <?= getTitle(); ?></title>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?= urlTo('/') ?>" class="d-block">Hai, <?= $_SESSION['username']; ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item <?= menuOpen(['user', 'kategoribuku', 'buku', 'peminjam']); ?>">
                            <a href="#"
                                class="nav-link <?= menuActive(['user', 'kategoribuku', 'buku', 'peminjam']); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= urlTo('/kategoribuku'); ?>"
                                        class="nav-link <?= menuActive(['kategoribuku']); ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= urlTo('/peminjam'); ?>"
                                        class="nav-link <?= menuActive(['peminjam']); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= urlTo('/perpustakaan'); ?>"
                                        class="nav-link <?= menuActive(['perpustakaan']); ?>">
                                        <i class="fas fa-list nav-icon"></i>
                                        <p>Daftar Buku</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= urlTo('/peminjaman'); ?>"
                                        class="nav-link <?= menuActive(['peminjaman']); ?>">
                                        <i class="fas fa-book nav-icon"></i>
                                        <p>Buku Pinjaman</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= urlTo('/koleksi'); ?>"
                                        class="nav-link <?= menuActive(['koleksi']); ?>">
